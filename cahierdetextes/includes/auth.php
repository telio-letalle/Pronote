 ...
 * Ce fichier adapte la classe Auth du répertoire login pour le système de cahier de textes
 */
...
/**
 * Vérifie si l'utilisateur a le droit de gérer les devoirs
 * 
 * @return bool
 */
...
// Vérifie que l'utilisateur est connecté pour accéder à toutes les pages du système de cahier de textes
requireLogin();
?>