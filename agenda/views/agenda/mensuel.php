...
<head>
    ...
    <title>Agenda Pronote Web - Vue Mensuelle</title>
    ...
    <main class="container">
        <div class="toolbar">
            ...
            <div class="view-selector">
                ...
                <button id="view-mon" class="view-button active">Mois</button>
            </div>
        </div>
