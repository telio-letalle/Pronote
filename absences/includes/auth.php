<?php
/**
 * Authentication functions for absences module
 */
...
if ($path_helper) {
    ...
    if ($api_path) {
        ...
        // Last resort - create minimal authentication service
        error_log("Cannot locate API auth file. Using minimal auth fallback in absences/includes/auth.php");
        ...
        if (!function_exists('isStudent')) {
            function isStudent() {
                return isset($_SESSION['user']) && $_SESSION['user']['profil'] === 'eleve';
            }
        }
        
        if (!function_exists('isParent')) {
            function isParent() {
                return isset($_SESSION['user']) && $_SESSION['user']['profil'] === 'parent';
            }
        }
